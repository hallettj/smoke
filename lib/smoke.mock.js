...
Smoke.Mock.Expectation.prototype = {
	...
	run: function(args){
		if(typeof(this.callerArgs) == 'undefined' || this.compareArguments(args, this.callerArgs)) {
			this.callCount+=1;
			return true;
		};
		return false
	...
	parseCount: function(c){
        ...
        compare: function(a,b) {
            // If b is an argument matcher then invoke its `match` method.
            if (typeof(b) == 'object' && typeof(b.match) == 'function') {
                return b.match(a);

            } else if (typeof(a) == 'object' && typeof(a.compare) == 'function') {
        ...
        compareArguments: function(a,b) {
            return this.compare(Array.prototype.slice.call(a), Array.prototype.slice.call(b));
        }
};
